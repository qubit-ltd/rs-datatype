...
use super::conversion_budget_limits::ConversionBudgetLimits;
...
pub struct DataConversionOptions {
    ...
    /// Cumulative budgets shared by one conversion session.
...
impl DataConversionOptions {
    ...
    pub fn strict() -> Self {
        Self {
            ...
            budget: ConversionBudgetLimits::default(),
        }
    }
    ...
    /// Returns the cumulative conversion budgets.
    #[must_use = "conversion budgets should be inspected"]
    #[inline(always)]
    pub const fn budget(&self) -> &ConversionBudgetLimits {
        &self.budget
    }
    ...
    /// Creates a fresh reusable conversion accounting session.
    #[inline]
    pub fn session(&self) -> crate::converter::ConversionSession<'_> {
        crate::converter::ConversionSession::new(self)
    }
}
