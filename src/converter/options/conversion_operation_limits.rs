...
pub struct ConversionOperationLimits {
    ...
    items: ResourceLimit<ConversionResource, usize>,

    /// Cumulative normalized input byte limit.
    input_bytes: ResourceLimit<ConversionResource, usize>,

    /// Cumulative output payload byte limit.
    output_bytes: ResourceLimit<ConversionResource, usize>,

    /// Cumulative structured value node limit.
    structured_nodes: ResourceLimit<ConversionResource, usize>,

    /// Cumulative structured key, string, and number payload byte limit.
    structured_payload_bytes: ResourceLimit<ConversionResource, usize>,
}
...
impl ConversionOperationLimits {
    ...
    pub const DEFAULT_MAX_STRUCTURED_PAYLOAD_BYTES: usize = 64 * 1024 * 1024;
    ...
    #[inline(always)]
    pub const fn max_structured_payload_bytes(&self) -> usize {
